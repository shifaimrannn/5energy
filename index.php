                    ...
                    <div class="wrapper">
                        <nav>
                            ...
                            <div class="for-res-navbr">
                                ...
                                <a href="#contact" class="web-btn">Get in touch</a>
                            </div>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div>
                                ...
                                <!--<h5 class="d-blue-heading-38">Project Services</h5>-->
                                <p class="web-pra">5Energy offers specialized project solutions tailored for clients in the
                                    energy industry, with a strong commitment to supporting the region's
                                    transition to a low-carbon economy.</p>

                                <!-- <h5 class="d-blue-heading-38">Providing Engineering Solutions
                                    to 5 Industries</h5> -->
                                <p class="web-pra">Our services encompass technical project support, project
                                    management, and technical recruitment for energy developers,
                                    consultants, and engineering and contracting firms.</p>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="addres">
                                ...
                                <a href="mailto:hr@5energyglobal.com" class="ps-3">hr@5energyglobal.com</a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <form>
